...
{
    public partial class PGAdmissionCheck : UserControl, IWizard
    {
        ...
        public PGAdmissionCheck(int yr_selection, string oldstuno, string ref_no)
        {
            InitializeComponent();
            this.ref_no = ref_no;
        ...
        public bool ShowView()
        {
            try
            {
                ...
                rbThisYear.Text = string.Concat("This Year (", DateTime.Today.Year, ")");
                rbNextYear.Text = string.Concat("Next Year (", DateTime.Today.Year + 1, ")");

                if (yr_selection == DateTime.Today.Year) rbThisYear.Checked = true;
                if (yr_selection == DateTime.Today.Year + 1) rbNextYear.Checked = true;
        ...
        public bool Next()
        {
            try
            {
                ...
                int app_type = (int)Enumerations.AdmissionApplicationType.PG;
                bool adm_session = rbThisYear.Checked;
